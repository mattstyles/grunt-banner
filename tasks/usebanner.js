            ...
            file.src.forEach( function ( src ) {
                if ( grunt.file.isFile( src ) ) {
                    ...
                    if ( options.replace ) {
                        ...
                        replacingPrevious = ( fileContents.indexOf(insertPositionMarker) >= 0 );
                    }
                    ...
                    var insertPositionMarkerRe = new RegExp( insertPositionMarker, 'g' );
                    grunt.file.write( src,
                        options.position === 'replace' && replacingPrevious  ?
                        fileContents.replace( insertPositionMarkerRe, options.banner ) :
                        options.position !== 'bottom' ?
                        options.banner + linebreak + fileContents.replace( insertPositionMarkerRe, '' ) :
                        fileContents.replace( insertPositionMarkerRe, '' ) + linebreak + options.banner
                    );
